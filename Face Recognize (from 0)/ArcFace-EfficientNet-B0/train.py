...
from model import FaceRecognitionModel # ต้องแน่ใจว่า model.py ของ ArcFace ถูกต้อง

# --- Configuration ---
DATA_DIR = 'dataset' # ชี้ไปที่โฟลเดอร์แม่ของ train/test
MODEL_SAVE_DIR = 'saved_model'
MODEL_NAME = 'arcface_efficientnet_b0_from_scratch.pth'
BACKBONE_NAME = 'arcface_efficientnet_b0_from_scratch_backbone.pth'
CLASS_MAPPING_NAME = 'class_mapping.json'
PLOT_SAVE_PATH = 'training_history_arcface_from_scratch.png'

# Hyperparameters
IMG_SIZE = 224
BATCH_SIZE = 16
EPOCHS = 80 # ลองเทรนให้นานขึ้นเพื่อดูผล
LEARNING_RATE = 0.001
# Embedding size ถูกกำหนดใน model.py
