...
class FaceRecognitionModel(nn.Module):
    def __init__(self, num_classes, embedding_size=512, backbone_name='efficientnet_b0'):
        super(FaceRecognitionModel, self).__init__()
        self.backbone = timm.create_model(backbone_name, pretrained=False, num_classes=0) # num_classes=0 to get features
