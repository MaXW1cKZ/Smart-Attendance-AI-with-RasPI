...
PLOT_SAVE_PATH = 'training_history_sphereface_finetune.png' # เปลี่ยนชื่อไฟล์ plot
...
def train():
    ...
    # Initialize model with pretrained=True
    ...
    for epoch in range(EPOCHS):
        ...
        for images, labels in progress_bar:
            ...
            log_probs = F.log_softmax(output_from_sphereface, dim=-1) # ต้องใช้ F.log_softmax เพื่อให้เข้ากับ NLLLoss
