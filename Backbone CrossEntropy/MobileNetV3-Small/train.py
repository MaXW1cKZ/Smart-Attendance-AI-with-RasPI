...
MODEL_NAME = 'mobilenetv3_small_100_crossentropy.pth'
CLASS_MAPPING_NAME = 'class_mapping.json'
PLOT_SAVE_PATH = 'training_history_mobilenetv3_small_100_crossentropy.png'
...
BACKBONE_NAME = 'mobilenetv3_small_100' # ชื่อ backbone ที่ใช้
