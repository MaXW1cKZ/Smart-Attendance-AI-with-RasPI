...
MODEL_NAME = 'efficientnet_b0_crossentropy.pth'
CLASS_MAPPING_NAME = 'class_mapping.json'
PLOT_SAVE_PATH = 'training_history_efficientnet_b0_crossentropy.png'
...
BACKBONE_NAME = 'efficientnet_b0'  # ชื่อ backbone ที่ใช้
